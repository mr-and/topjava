...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal meal : meals) {
            ...
            sumCalories.merge(mealDate, meal.getCalories(), Integer::sum);
        }
        ...
        for (UserMeal meal : meals) {
            ...
            if (TimeUtil.isBetweenInclusive(localDateTime.toLocalTime(), startTime, endTime)) {
                userMealWithExcesses.add(
                        new UserMealWithExcess(localDateTime,
                                meal.getDescription(),
                                meal.getCalories(),
                                sumCalories.get(localDateTime.toLocalDate()) > caloriesPerDay)
                );
            }
        }
